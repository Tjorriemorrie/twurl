...
var Read = React.createClass({
	...
	getInitialState: function () {
		...
		console.info('[Read] getInitialState:', state);
		return state;
	},

	componentDidMount: function () {
		console.info('[Read] componentDidMount');
	...
	componentWillUnmount: function () {
		console.info('[Read] componentWillUnmount');
	},

	render: function () {
		console.info('[Read] render link_id:', this.props.link_id);
		return (
